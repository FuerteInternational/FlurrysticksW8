...
namespace Flurrysticks.Data
{
    ...
    public abstract class SampleDataCommon : Flurrysticks.Common.BindableBase
    {
    ...
    /// </summary>
    public class SampleDataItem : Flurrysticks.Common.BindableBase
    {
    ...
    /// </summary>
    public class SampleDataGroup : Flurrysticks.Common.BindableBase
    {
