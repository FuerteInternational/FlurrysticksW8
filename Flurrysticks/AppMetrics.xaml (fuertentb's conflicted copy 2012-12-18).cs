...
namespace Flurrysticks
{
    ...
    public sealed partial class AppMetrics : Flurrysticks.Common.LayoutAwarePage
    {
        ...
        private void ParseXML(XDocument what)
        {
           ...
           RadCartesianChart actualChart = Util.FindFirstElementInVisualTree<RadCartesianChart>(flipView1.ItemContainerGenerator.ContainerFromIndex(0));         
           actualChart.DataContext = ChartData;
        } // ParseXML
        ...
        private void initFlipView()
        {
            ...
            //flipView1.ItemsSource = AppMetricsNames;
            for (int i=0;i<AppMetricsNames.Count();i++) {

                flipView1.Items.Add(AppMetricsNames[i]);
